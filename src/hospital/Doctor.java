...
public class Doctor extends Employee {
    ...
    public Doctor( String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus, double totalSalery) {
    ...
    public void insert(String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus){
        ...
        try {
            ...
            query = "INSERT INTO doctors (name,addres,phone,department,birthDay,currentMonth" +
            ...
            JOptionPane.showMessageDialog(null,"Data Inserted","INSERT",JOptionPane.INFORMATION_MESSAGE);
    ...
    public void deleteItem(String name){
        ...
        try {
            ...
            query = "delete from doctors where name = '"+name+"'";
    ...
    public void update(String sear,String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus){
        ...
        try {
            connection = dataBase.conn();
            statement = connection.createStatement();
            query = "Update doctors set name='"+name+"'  ,addres='"+address+"',phone='"+phone+"'" +
