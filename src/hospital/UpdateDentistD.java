 ...
 * @author EGYPT-LAPTOP
 */
public class UpdateDentistD extends javax.swing.JFrame {

    /**
     * Creates new form UpdateDentistD
     */
    public UpdateDentistD() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            dentistDoctorsDB.update(sear, name, age, phone, eyeD, numOfEx, num, price);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDentistD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateDentistD().setVisible(true);
            }
        });
    }
