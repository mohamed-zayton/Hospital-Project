 ...
 * @author EGYPT-LAPTOP
 */
public class DeleteEmergyD extends javax.swing.JFrame {

    /**
     * Creates new form DeleteEmergyD
     */
    public DeleteEmergyD() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            emergencyDoctorsDB.deleteItem(name);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEmergyD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteEmergyD().setVisible(true);
            }
        });
    }
