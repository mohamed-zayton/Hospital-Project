...
public class UpdateShow extends UpdateFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b2){
            ...
            try{
                doctor.update(sear,name,addres,phone,department,birthDay,currentMonth,getSalery,saleryDouble,bonusDouble);
