 ...
 * @author EGYPT-LAPTOP
 */
public class UpdateEmergyD extends javax.swing.JFrame {

    /**
     * Creates new form UpdateEmergyD
     */
    public UpdateEmergyD() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Emergency Doctor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String eyeD= jTextField5.getText();
        String numOfEx=jTextField6.getText();
        String num=jTextField7.getText();
        String price=jTextField8.getText();

        try {
            emergencyDoctorsDB.update(sear, name, age, phone, eyeD, numOfEx, num, price);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateEmergyD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateEmergyD().setVisible(true);
            }
        });
    }
