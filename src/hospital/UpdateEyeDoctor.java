 ...
 * @author EGYPT-LAPTOP
 */
public class UpdateEyeDoctor extends javax.swing.JFrame {

    /**
     * Creates new form UpdateEyeDoctor
     */
    public UpdateEyeDoctor() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String eyeD= jTextField5.getText();
        ...
        try {
            eyePatientDB.update(sear, name, age, phone, eyeD, numOfEx, num, price);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateEyeDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateEyeDoctor().setVisible(true);
            }
        });
    }
