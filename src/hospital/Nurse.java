...
public class Nurse extends Employee {
    ...
    public Nurse(int id, String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus, double totalSalery) {
    ...
    public void insert(String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus){
        ...
        try {
            ...
            query = "INSERT INTO nurse (name,addres,phone,department,birthDay,currentMonth" +
    ...
    public void deleteItem(String name){
        ...
        try {
            ...
            query = "delete from nurse where name = '"+name+"'";
    ...
    public void update(String sear,String name, String address, String phone, String department, String brithDay, String currentMonth, String getHisMoney, double salery, double bonus){
        ...
        try {
            connection = dataBase.conn();
            statement = connection.createStatement();
            query = "UPDATE nurse set name='"+name+"',addres='"+address+"',phone='"+phone+"'" +
